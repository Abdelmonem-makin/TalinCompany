...
@section("content")
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="{{ route("purchases.edit-full", $purchase) }}" class="btn btn-warning">تعديل كامل</a>
    ...
    <div class="card mb-3">
        ...
        <h4>الشتريات</h4>
        <table class="table-bordered mb-3 table">
            <thead>
                <tr>
                    <th>اسم الصنف</th>
                    <th>الكميه</th>
            ...
            <tbody>
                @foreach ($purchase->purchaseLines as $line)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route("purchase-lines.destroy", $line) }}" method="POST"
