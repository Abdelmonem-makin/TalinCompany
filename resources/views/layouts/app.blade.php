            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav text-light ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('sales.index') }}">المبيعات والفواتير</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('purchases.index') }}">المشتريات  </a></li>
                                ...
                                <div class="dropdown-menu dropdown-menu-end  " aria-labelledby="navbarDropdown">
                                 ...
                                 <a class="dropdown-item" href="{{ route('accounts.index') }}">التقارير</a>
